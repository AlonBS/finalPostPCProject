...
//				}
	...
	/**
	 * 
	 * businessNameTextView = (TextView) v.findViewById(R.id.business_name_editText);
		businessTypeSpinner = (Spinner) v.findViewById(R.id.business_type_Spinner);
		if (app_mode == IntroFragment.BUSINESS_MODE) {
