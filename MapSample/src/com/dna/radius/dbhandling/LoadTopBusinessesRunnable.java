...
public class LoadTopBusinessesRunnable implements Runnable{
	...
	public void run() {
		while(!stopFlag){
			...
			final BusinessMarker bm = new BusinessMarker("MCdonalds", BuisnessType.RESTURANT, new LatLng(31.781099, 35.217668), "Jerusalem",0,new Random().nextInt(99999),new Random().nextInt(99999));
